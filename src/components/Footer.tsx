        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              <li><Link href="/boutique?cat=accessoires" className="hover:text-white transition-colors">Accessoires</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              <li><Link href="/livraison" className="hover:text-white transition-colors">Retours &amp; Remboursements</Link></li>
              <li><Link href="/faq" className="hover:text-white transition-colors">FAQ</Link></li>
              <li><Link href="/faq" className="hover:text-white transition-colors">Guide des tailles</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              <li><Link href="/suivi-commande" className="hover:text-white transition-colors">Suivi de commande</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://instagram.com/tdssneakers" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
              ...
              <a href="https://tiktok.com/@tdssneakers" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="TikTok">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-gray-800 py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} TDSSNEAKERS. Tous droits réservés.
          </p>
